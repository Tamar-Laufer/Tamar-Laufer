<!--
============================================================
  TAMAR LAUFER — GitHub Profile README
  ------------------------------------------------------------
  Clean Version - Icons Only (No External Images)
============================================================
-->
...
An analytical and passionate software developer with a solid foundation in **systems programming**, **data engineering**, and **artificial intelligence**. I bridge complex mathematical logic with modern software architecture — leveraging **agentic coding** and advanced AI workflows to deliver clean, optimized, high-performance solutions.

```ts
const tamar = {
  role:       "Software Engineer",
  education:  ["B.Sc. @ JCT", "Practical Engineering Diploma (MAHAT)"],
  focus:      ["AI / Deep Learning", "Data Engineering", "Full-Stack"],
  toolbelt:   ["C++", "Python", "JavaScript", "React", "Node.js"],
  mindset:    "bridge math logic ⟶ clean, high-performance software",
...
- 🎓 &nbsp;**B.Sc. in Software Engineering / Computer Science** — *Jerusalem College of Technology (JCT)*
  <br/><sub>Specializations in AI & Deep Learning, Advanced SQL Architecture, Object-Oriented Design, and Theoretical Computer Science.</sub>
- 📐 &nbsp;**Practical Engineering Diploma (MAHAT)** — *Computer Science & Software Studies*
- 🏅 &nbsp;**Senior Certified Teacher Certificate** — *Ministry of Education (Computer Science Emphasis)*
...
🔗 **[LinkedIn - Tamar Laufer](https://www.linkedin.com/in/tamar-laufer-600b1a376)** &nbsp;|&nbsp; ✉️ **[tamar4212@gmail.com](mailto:tamar4212@gmail.com)**

<br/><br/>

<sub><code>&gt;</code> Thanks for visiting — <b>build something great.</b> ✨</sub>
